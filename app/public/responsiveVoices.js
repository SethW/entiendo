...
console.log(responsiveVoice);
    ...
    a.speak=function(b, c, e) {
        ...
        a.iOS9_initialized=!0;
            ...
            b=b.replace(/[\"\`]/gm,"'");a.msgparameters=e||{};a.msgtext=b;a.msgvoicename=c;a.onstartFired=!1;var h=[];if(b.length>a.CHARACTER_LIMIT){for(var f=b;f.length>a.CHARACTER_LIMIT;){var g=f.search(/[:!?.;]+/),d="";if(-1==g||g>=a.CHARACTER_LIMIT)g=f.search(/[,]+/);-1==g&&-1==f.search(" ")&&(g=99);if(-1==g||g>=a.CHARACTER_LIMIT)for(var k=f.split(" "),g=0;g<k.length&&!(d.length+k[g].length+1>a.CHARACTER_LIMIT);g++)d+=(0!=g?
 " ": "")+k[g];
    ...
    g++)if(a.fallbackMode) {
        ...
        k=a.selectBest([a.iOS9?1: null, f.collectionvoice.rate, f.systemvoice.rate, 1]), l=a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1]), m;
...
a.getEstimatedTimeLength=function(b, c) {
    ...
    Session.set('pauseLength',d);
    console.log("Estimated time length: "+d+" ms, words: ["+e+"], charsCount: "+h);
    return d
}
